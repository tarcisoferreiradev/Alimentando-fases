...
// 5. EXPORTAÇÃO MODULAR
// Cria uma referência local para o global window.firebase
const firebaseApp = window.firebase;

// Exporta essa variável local com o nome 'firebase'
export { db, auth, firebaseApp as firebase };